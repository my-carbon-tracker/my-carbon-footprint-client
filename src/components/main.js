...
const useStyles = makeStyles((theme) => ({
  heroContent: {
    padding: theme.spacing(16, 30, 16),
        ...
        <Container maxWidth="lg" className={classes.textBox}>
          ...
          <Typography spacing="10px">
            ...
            <span>
              ...
              average. Here's your chance to put some of that carbon back in the
              ground.
            </span>
          </Typography>
      ...
      <div className={classes.spacing} align="center">
        ...
        >
          ...
          >
            ...
            warming under the 1.5°C threshold, a count down of how long it will
            take, at our current rates of emissions, to burn through our carbon
            budget. The second number, in green, is the growing percentage of
            the world’s energy currently supplied by renewable sources, our
            lifeline. The goal is to get our lifeline to 100% before our
            deadline reaches 0.
          </Container>
          <Container
            style={{
