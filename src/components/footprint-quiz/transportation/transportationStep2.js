...
export default function(props){
    ...
    return(
        <div>
            ...
            {modesOfTransport.bus && <TextField style={{margin:20}} id='busDistance' label='Bus' type="number" InputLabelProps={{shrink: true,}} variant="outlined" color="secondary" value={busDistance} onChange={(e)=>setBusDistance(e.target.value)}/>}
            {modesOfTransport.car && <TextField style={{margin:20}} id='carDistance' label='Car' type="number" InputLabelProps={{shrink: true,}} variant="outlined" color="secondary" value={carDistance} onChange={(e)=>setCarDistance(e.target.value)}/>}
            {modesOfTransport.carSharing && <TextField style={{margin:20}} id='carSharingDistance' label='Car Sharing' type="number" InputLabelProps={{shrink: true,}} variant="outlined" color="secondary" value={carSharingDistance} onChange={(e)=>setCarSharingDistance(e.target.value)}/>}
            {modesOfTransport.electric && <TextField style={{margin:20}} id='electricDistance' label='Electric Vehicle' type="number" InputLabelProps={{shrink: true,}} variant="outlined" color="secondary" value={electricDistance} onChange={(e)=>setElectricDistance(e.target.value)}/>}
